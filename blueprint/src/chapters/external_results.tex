...
\begin{theorem}[BJM/BX criterion for the source choice]
  ...
  % VERIFIED-IN: KIP126/External/Literature/Kervaire.lean,
  % KIP126.Kervaire.cataloguedBJM_BXCriterion (interface; remains notready).
...
\begin{theorem}[External $\theta_5$ order and choice comparison]
  ...
  % VERIFIED-IN: KIP126/External/Literature/Kervaire.lean,
  % KIP126.Kervaire.cataloguedTheta5OrderData (interface; remains notready).
  \uses{def:synthetic-theta5-choice,def:external-result}
  \notready
...
\begin{theorem}[Total differential identity for an order-two choice]
  ...
  % VERIFIED-IN: KIP126/External/Literature/Kervaire.lean,
  % KIP126.Kervaire.cataloguedTotalDifferentialIdentity (interface; remains notready).
